...
- A box will pop up asking you whice file format you would like. Click on `Data`.
- This will open a new window with a `Summary` and `Full Data` tab. Click on `Full Data`.
- On the `Full Data` tab click on `Download all rows as a text file` and you given the option to download the data to your machine. 
